package com.vtest.it.testerdatalogdealplatform.configuration;
...
@Configuration
@MapperScan(value = "com.vtest.it.testerdatalogdealplatform.dao.mes",sqlSessionTemplateRef = "mesSqlSessionTemplate")
