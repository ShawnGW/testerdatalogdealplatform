...
public class DatalogRegexSamples {
    public static final String J750REGEX = "VTEST_CP_(\\w{3})_([\\.\\w-]{1,}|[\\.\\w-_\\(\\)]{1,})_([A-Z0-9-\\.]{1,})_([\\w-\\.]{1,})_(TT[A-Z]{1}-[\\dA-Z]{2,4})_([0-9A-Z-]{1,})_([0-9A-Z-_]{1,})_(CP[0-9]{1,})_(RP[0-9]{1})_([Vv]{1}[0-9]{3,}|[0-9]{4,})_([0-9]{8}_[0-9]{6})\\.([A-Za-z0-9]{1,})";
    public static final String V93000REGEX = "VTEST_CP_(\\w{3})_([\\.\\w-]{1,}|[\\.\\w-_\\(\\)]{1,})_([A-Z0-9-\\.]{1,})_([\\w-\\.]{1,})_(TT[A-Z]{1}-[\\dA-Z]{2,4})_([0-9A-Z-]{1,})_([0-9A-Z-_]{1,})_(CP[0-9]{1,})_(RP[0-9]{1})_([Vv]{1}[0-9]{3,}|[0-9]{4,})_([0-9]{8}_[0-9]{6})\\.([A-Za-z0-9]{1,})";
    ...
    public static final String V50REGEX = "VTEST_CP_(\\w{3})_([\\.\\w-]{1,}|[\\.\\w-_\\(\\)]{1,})_([A-Z0-9-\\.]{1,})_([\\w-\\.]{1,})_(TT[A-Z]{1}-[\\dA-Z]{2,4})_([0-9A-Z-]{1,})_([0-9A-Z-_]{1,})_([Vv]{1}[0-9]{3,}|[0-9]{4,})_(CP[0-9]{1,})_(RP[0-9]{1})_([0-9]{8}_[0-9]{6})\\.([A-Za-z0-9]{1,})";
